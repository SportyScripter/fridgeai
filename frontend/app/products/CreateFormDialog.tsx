...
interface ProductCreateFormDialogProps {
  input: ProductData;
  setInput: Dispatch<SetStateAction<ProductData>>;
  open: boolean;
  handleSubmit: (data: ProductData) => void;
  handleClose: () => void;
}

export default function ProductCreateFormDialog({
  input,
  setInput,
  open,
  handleSubmit,
  handleClose,
}: ProductCreateFormDialogProps) {
  return (
